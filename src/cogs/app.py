...
class MyView(discord.ui.View):
    ...
    async def first_button_callback(self, button, interaction):
      ...
      FunEmbed.add_field(name="***(VC)Join:***", value=" **•** (Prefix command) eg: !p rickroll Plays a song", inline = False)
      FunEmbed.add_field(name="***(VC)Leave:***", value=" **•** (Prefix command) Makes bot leave the vc", inline = False)
