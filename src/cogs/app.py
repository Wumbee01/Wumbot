...
class MyView(discord.ui.View):
    ...
    async def first_button_callback(self, button, interaction):
      ...
      FunEmbed.add_field(name="***Help_ut:***", value=" **•** (Prefix command) format: !help_ut, Help/info on the game", inline=False)
      FunEmbed.add_field(name="***Join_ut:***", value=" **•** (Prefix command) format: !join_ut <character>, Join the game with x character", inline=False)
      FunEmbed.add_field(name="***Start_ut:***", value=" **•** (Prefix command) format: !start_ut, Starts the game", inline=False)
      FunEmbed.add_field(name="***Fight_ut:***", value=" **•** (Prefix command) format: !fight_ut, Fight opponent", inline=False)
      FunEmbed.add_field(name="***Act_ut:***", value=" **•** (Prefix command) format: !act_ut, Use a random action", inline=False)
      FunEmbed.add_field(name="***Mercy_ut:***", value=" **•** (Prefix command) format: !mercy_ut, Spare the player", inline=False)
      FunEmbed.add_field(name="***Stats_ut:***", value=" **•** (Prefix command) format: !stats_ut, See your stats", inline=False)
      ...
      FunEmbed.add_field(name="***Dice:***", value=" **•** (Prefix command) format: !dice <number>, Chooses a random number from 1 to whatever you chose", inline=False)
      ...
      FunEmbed.add_field(name="***2ball:***", value=" **•** (Slash command) Yes or no", inline=False)
      FunEmbed.add_field(name="***8ball:***", value=" **•** (Slash command) Classic 8ball", inline=False)
      ...
      FunEmbed.add_field(name="***RPS:***", value=" **•** (Slash command) Fancy Rock Paper Scissors", inline=False)
      FunEmbed.add_field(name="***Coinflip:***", value=" **•** (Slash command) Flips a coin", inline=False)        
      ...
      FunEmbed.add_field(name="***Guess:***", value=" **•** (Slash command) Guess a number from 1~10", inline = False)
